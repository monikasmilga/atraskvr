...
<html lang="{{ config('app.locale') }}">
    ...
    <div class="links"><br>
        ...
        <a href="http://atraskvr.dev/admin/languages">Languages</a>
        <a href="http://atraskvr.dev/admin/users">Users</a>
        <a href="http://atraskvr.dev/admin/roles">Roles</a>
        <a href="http://atraskvr.dev/admin/permissions">Permissions</a>
    </div>
